...
from Application.Views.Models.ListModel import PiecesModel



class Ui_Banned(QMainWindow):

    sgFin=pyqtSignal()
    ################################# Intialization Here ##################################################
    def __init__(self,parent=None):
        super(Ui_Banned, self).__init__(parent=None)
        try:
            ...
            self.listBSym.setModel(self.model)

            self.model1 = PiecesModel([])
            self.listBIns.setModel(self.model1)
