...
QWidget {
  ...
  padding: 0px;
  color: #F0F0F0;
  selection-background-color: #283740;
...
QTabBar::tab:top:selected {
  background-color: #505F69;
  color: #F0F0F0;
  border-bottom: 3px solid #283740;
  border-top-left-radius: 3px;
  border-top-right-radius: 3px;
}
...
QToolBox::tab:selected {
  background-color: #505F69;
  border-bottom: 2px solid #283740;
}
